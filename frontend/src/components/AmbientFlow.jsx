  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none bg-slate-50/30">
      ...
      <motion.div
        initial={{ opacity: 0 }}
        animate={{
          opacity: 0.15, // Slightly higher than 0.1 to cut through the heavy blur
          x: [0, 80, -40, 0],
          y: [0, 60, -60, 0],
          scale: [1, 1.1, 0.9, 1],
          rotate: [0, 90, 180, 360]
      ...
      <motion.div
        initial={{ opacity: 0 }}
        animate={{
          opacity: 0.25, // Mint is lighter, needs a tiny bit more opacity
          x: [0, -100, 50, 0],
          y: [0, -80, 40, 0],
          scale: [1, 1.2, 0.8, 1],
          rotate: [360, 180, 90, 0]
      ...
      {/* Blob 4: Mint Green (Bottom Right - smaller balancing blob) */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{
          opacity: 0.15,
