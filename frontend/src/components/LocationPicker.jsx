...
// NOTE: Ensure your DonateFood.jsx passes 'onConfirm' and 'onCancel' as props!
const LocationPicker = ({ onConfirm, onCancel }) => {
  const [position, setPosition] = useState([23.2599, 77.4126]); // Defaulted to Bhopal for you
  ...
  return (
    <div className="flex flex-col h-125 w-full bg-white rounded-2xl overflow-hidden shadow-2xl relative">
      ...
      <div className="p-4 bg-white z-10 border-t border-gray-100">
        ...
        {/* THE ONLY CHANGE IS HERE! Passing lat and lng alongside the address */}
        <button 
          onClick={() => onConfirm(address, position[0], position[1])}
