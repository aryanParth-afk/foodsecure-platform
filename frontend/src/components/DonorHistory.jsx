                ...
                <div key={group.date} className="mb-8">
                  ...
                  <div className="space-y-4">
                    {group.items.map((donation) => (
                      <motion.div 
                        key={donation._id} 
                        layout="position" // This stops the magnifying stretching glitch!
                        className="bg-white border border-slate-100 p-6 rounded-3xl shadow-sm hover:shadow-md transition-all relative overflow-hidden group flex flex-col md:flex-row md:items-center justify-between gap-6 pl-6"
                      >
